                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary" type="submit">Cari
                                                    Data</button>
                                                <a class="btn btn-outline-danger"
                                                    href="<?= base_url; ?>/kategori">Reset</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url; ?>/kategori/edit/<?= $row['id'] ?>"
                                                class="badge badgeinfo ">Edit</a> <a
                                                href="<?= base_url; ?>/kategori/hapus/<?= $row['id'] ?>" class="badge 
